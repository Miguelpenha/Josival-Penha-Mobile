...
import { ContainerButtons, Icon, IconMaterial } from './style'
...
function Spreadsheets() {
  ...
  return (
    <ContainerPd scroll>
      ...
      <ContainerButtons>
        <Button title="Professoras" index={1} onPress={() => generateSpreadsheet('/export/Professoras', 'Planilhas de professoras')}>
        ...
        <Button title="Turmas" index={2} onPress={() => generateSpreadsheet('/export/Turmas', 'Planilhas de turmas')}>
